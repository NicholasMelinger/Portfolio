...
class DefaultController extends Controller
{
    ...
    public function index2Action()
    {
        ...
        return $this->render('PortfolioBundle:Default:index2.html.twig', array('utilisateurs' => $utilisateurs, 'resultatComp' => $resultatComp->fetchAll(), 'resultatCursus' => $resultatCursus->fetchAll()));
    }
