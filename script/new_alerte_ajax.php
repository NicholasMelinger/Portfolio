...
if(isset($_POST["competence_id"]) && $_POST["competence_id"] != -1){
	...
	//ajout dans alerte
	$query_insert_alerte = "INSERT INTO Alertes (commentaire, competence_id, date_creation_alerte, utilisateur_id, flag_actif) VALUES ('".str_replace('\'','\'\'',$_POST["comment"])."', ".$_POST["competence_id"].", NOW(), ".$_POST["id"].", 1 );";
